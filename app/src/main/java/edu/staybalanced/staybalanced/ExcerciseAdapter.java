...
public class ExcerciseAdapter extends RecyclerView.Adapter<ExcerciseAdapter.ExcerciseRowHolder> implements Filterable {
    ...
    ArrayList<ExcerciseItem> excerciseData;
    Context context;
    ArrayList<ExcerciseItem> allExcercises;

    public ExcerciseAdapter(ArrayList<ExcerciseItem> excerciseDataIn, Context contextIn){
    ...
    Filter filter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            ArrayList<ExcerciseItem> filteredExcercises = new ArrayList<>();

            if (charSequence.toString().isEmpty()){
                filteredExcercises.addAll(allExcercises);
            }
            else {
                for (ExcerciseItem e: allExcercises) {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            excerciseData.clear();
            excerciseData.addAll((Collection<? extends ExcerciseItem>) filterResults.values);
